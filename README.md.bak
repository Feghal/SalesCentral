...
Swift SDK for the **central_sales_rest** backend. Wraps every operation —
users, signed-receipt validation, subscriptions, credits, sessions, custom
events — behind a single `SalesClient` actor.
...
```swift
dependencies: [
    .package(url: "https://github.com/your-org/central_sales_rest.git", from: "1.0.0")
],
targets: [
    .target(name: "MyApp", dependencies: [
        .product(name: "SalesCentral", package: "central_sales_rest"),
    ])
]
```
...
MIT (or whatever your org adopts).
